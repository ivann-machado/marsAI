        ...
        <>
            ...
            <div className="w-full overflow-hidden bg-[#050508]">
                ...
                <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
                    ...
                    <div className="relative z-10 text-center px-4">
                        ...
                        <div className="mb-10">
                            ...
                            <div className="flex justify-center gap-4 md:gap-6">
                                {[
                                    ...
                                    { value: timeLeft.hours, label: t('homepage.countdown_hours') },
                                    { value: timeLeft.minutes, label: t('homepage.countdown_minutes') },
                                    { value: timeLeft.seconds, label: t('homepage.countdown_seconds') }
                                ].map((item, index) => (
                                    <div key={index} className="flex flex-col items-center">
                                        ...
                                        <span className="text-[#d1d5db] text-xs mt-2 uppercase tracking-wider">{item.label}</span>
                                    </div>
                                ))}
                            </div>
                        </div>

                        <div className={`${badge} bg-white/10 border border-white/20 text-white mb-8`}>
                        ...
                        <p className="font-orbitron font-semibold text-[clamp(20px,3vw,36px)] mb-6 text-white">
                            {t('homepage.hero_tagline')} <span className="text-[#10b981]">{t('homepage.hero_tagline_highlight')}</span> {t('homepage.hero_tagline_end')}
                        </p>
                ...
                <section className="py-8 bg-gradient-to-r from-[#1a0a2e] via-[#0a0a0f] to-[#1a0a2e] border-y border-[#a855f7]/30">
                    <div className={container}>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                            <div>
                                <h3 className="font-orbitron font-black text-2xl mb-1 text-white">{t('homepage.feature_1_title')}</h3>
                                <p className="text-xs text-[#d1d5db] tracking-wider uppercase">
                                    {t('homepage.feature_1_desc')}
                                </p>
                            </div>
                            <div>
                                <h3 className="font-orbitron font-black text-2xl mb-1 text-[#10b981]">{t('homepage.feature_2_title')}</h3>
                                <p className="text-xs text-[#d1d5db] tracking-wider uppercase">
                                    {t('homepage.feature_2_desc')}
                                </p>
                            </div>
                            <div>
                                <h3 className="font-orbitron font-black text-2xl mb-1 text-[#ec4899]">{t('homepage.feature_3_title')}</h3>
                                <p className="text-xs text-[#d1d5db] tracking-wider uppercase">
                                    {t('homepage.feature_3_desc')}
                                </p>
                            </div>
                            <div>
                                <h3 className="font-orbitron font-black text-2xl mb-1 text-[#06b6d4]">{t('homepage.feature_4_title')}</h3>
                                <p className="text-xs text-[#d1d5db] tracking-wider uppercase">
                ...
                <section className="py-32 bg-gradient-to-br from-[#050508] to-[#1a0a2e] relative overflow-hidden">
                    ...
                    <div className={`${container} relative z-10`}>
                        <h2 className={`${h2Style} text-center mb-16`}>
                            {t('homepage.objectives_title')} <span className="text-[#ec4899] drop-shadow-[0_0_20px_rgba(236,72,153,0.5)]">{t('homepage.objectives_title_highlight')}</span>
                        </h2>
                        
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className={`${card} p-10 text-center border-[#10b981]/30 hover:border-[#10b981]/50 transition-all duration-300 hover:translate-y-[-5px]`}>
                                ...
                                <h3 className="font-orbitron font-bold text-xl mb-4 text-[#10b981] whitespace-pre-line">{t('homepage.objective_1_title')}</h3>
                                <p className="text-[#d1d5db] text-sm leading-relaxed">
                                    {t('homepage.objective_1_desc')}
                                </p>
                            </div>
                            
                            <div className={`${card} p-10 text-center border-[#3b82f6]/30 hover:border-[#3b82f6]/50 transition-all duration-300 hover:translate-y-[-5px]`}>
                                <div className="w-20 h-20 mx-auto mb-6 flex items-center justify-center rounded-full bg-[#3b82f6]/20 text-[#3b82f6]">
                                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                        <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/>
                                    </svg>
                                </div>
                                <h3 className="font-orbitron font-bold text-xl mb-4 text-[#3b82f6] whitespace-pre-line">{t('homepage.objective_2_title')}</h3>
                                <p className="text-[#d1d5db] text-sm leading-relaxed">
                                    {t('homepage.objective_2_desc')}
                                </p>
                            </div>
                            
                            <div className={`${card} p-10 text-center border-[#a855f7]/30 hover:border-[#a855f7]/50 transition-all duration-300 hover:translate-y-[-5px]`}>
                                ...
                                <h3 className="font-orbitron font-bold text-xl mb-4 text-[#a855f7] whitespace-pre-line">{t('homepage.objective_3_title')}</h3>
                                <p className="text-[#d1d5db] text-sm leading-relaxed">
                ...
                <section className="py-32 bg-gradient-to-br from-[#0a0a0f] to-[#1a0a2e] relative overflow-hidden">
                    ...
                    <div className={`${container} relative z-10`}>
                        <div className="text-center mb-16">
                            <div className={`${badge} bg-[#f97316]/20 border border-[#f97316]/50 text-[#f97316] mb-8`}>
                                {t('homepage.callforfilms_badge')}
                            </div>
                            <h2 className={h2Style}>
                                {t('homepage.callforfilms_title')} <span className="text-[#f97316] drop-shadow-[0_0_20px_rgba(249,115,22,0.5)]">{t('homepage.callforfilms_title_highlight')}</span>
                            </h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                            <div className={`${card} p-8 text-center border-[#f97316]/30 hover:border-[#f97316]/50 transition-all duration-300`}>
                                <div className="font-orbitron font-black text-5xl text-[#f97316] mb-4">60s</div>
                                <h3 className="font-orbitron font-bold text-lg mb-2 text-white">{t('homepage.callforfilms_constraint_1_title')}</h3>
                                <p className="text-[#d1d5db] text-sm">{t('homepage.callforfilms_constraint_1_desc')}</p>
                            </div>
                            <div className={`${card} p-8 text-center border-[#10b981]/30 hover:border-[#10b981]/50 transition-all duration-300`}>
                                <div className="font-orbitron font-black text-5xl text-[#10b981] mb-4">IA</div>
                                <h3 className="font-orbitron font-bold text-lg mb-2 text-white">{t('homepage.callforfilms_constraint_2_title')}</h3>
                                <p className="text-[#d1d5db] text-sm">{t('homepage.callforfilms_constraint_2_desc')}</p>
                            </div>
                            <div className={`${card} p-8 text-center border-[#3b82f6]/30 hover:border-[#3b82f6]/50 transition-all duration-300`}>
                                <div className="font-orbitron font-black text-5xl text-[#3b82f6] mb-4">2</div>
                                <h3 className="font-orbitron font-bold text-lg mb-2 text-white">{t('homepage.callforfilms_constraint_3_title')}</h3>
                                <p className="text-[#d1d5db] text-sm">{t('homepage.callforfilms_constraint_3_desc')}</p>
                            </div>
                        </div>

                        <div className="text-center">
                            <Link to="/participate" className={`px-10 py-4 bg-gradient-to-r from-[#f97316] to-[#ec4899] text-white ${btn} ${btnHover} hover:shadow-[0_15px_40px_rgba(249,115,22,0.4)]`}>
                ...
                <section className="py-32 bg-[#0a0a0f]">
                    <div className={container}>
                        <div className="text-center mb-16">
                            <div className={`${badge} bg-[#a855f7]/20 border border-[#a855f7]/50 text-[#a855f7] mb-8`}>
                                {t('homepage.aitools_badge')}
                            </div>
                            <h2 className={h2Style}>
                                {t('homepage.aitools_title')} <span className="text-[#a855f7] drop-shadow-[0_0_20px_rgba(168,85,247,0.5)]">{t('homepage.aitools_title_highlight')}</span>
                            </h2>
                            <p className="text-[#d1d5db] text-lg max-w-3xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
                            {[
                                ...
                                <div key={index} className={`${card} p-6 text-center border-white/10 hover:border-[${tool.color}]/50 transition-all duration-300 hover:translate-y-[-5px]`}>
                                    <div className="text-4xl mb-4">{tool.icon}</div>
                                    <h3 className="font-orbitron font-bold text-sm text-white">{t(`homepage.aitools_${tool.key}`)}</h3>
                                </div>
                            ))}
                        </div>
                    </div>
