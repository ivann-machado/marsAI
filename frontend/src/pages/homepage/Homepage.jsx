        ...
        <>
            ...
            <div className="min-h-screen bg-black text-white">
                ...
                >
                    ...
                    <div className="relative z-10 text-center px-4 md:px-8">
                        ...
                        <p className="text-xl md:text-2xl font-bold mb-4 tracking-wide">
                            {t('hero_tagline')} <span className="text-green-400">{t('hero_tagline_highlight')}</span> {t('hero_tagline_end')}
                        </p>
                    ...
                    <div className="max-w-7xl mx-auto px-4 md:px-8">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            <div className="p-6 bg-zinc-900/50 border border-zinc-800 rounded-2xl hover:border-zinc-700 transition-all duration-300">
                                <h3 className="text-2xl font-black mb-2 text-white">{t('feature_1_title')}</h3>
                                <p className="text-gray-400 text-sm">
                                    {t('feature_1_desc')}
                                </p>
                            </div>
                            <div className="p-6 bg-zinc-900/50 border border-zinc-800 rounded-2xl hover:border-zinc-700 transition-all duration-300">
                                <h3 className="text-2xl font-black mb-2 text-green-400">{t('feature_2_title')}</h3>
                                <p className="text-gray-400 text-sm">
                                    {t('feature_2_desc')}
                                </p>
                            </div>
                            <div className="p-6 bg-zinc-900/50 border border-zinc-800 rounded-2xl hover:border-zinc-700 transition-all duration-300">
                                <h3 className="text-2xl font-black mb-2 text-pink-500">{t('feature_3_title')}</h3>
                                <p className="text-gray-400 text-sm">
                                    {t('feature_3_desc')}
                                </p>
                            </div>
                            <div className="p-6 bg-zinc-900/50 border border-zinc-800 rounded-2xl hover:border-zinc-700 transition-all duration-300">
                                <h3 className="text-2xl font-black mb-2 text-blue-400">{t('feature_4_title')}</h3>
                                <p className="text-gray-400 text-sm">
                                    {t('feature_4_desc')}
                                </p>
                            </div>
                    ...
                    <div className="max-w-7xl mx-auto px-4 md:px-8">
                        <div className="mb-12">
                            <h2 className="text-4xl md:text-5xl font-black mb-4">
                                {t('films_title')}<br />
                                <span className="text-gray-500">{t('films_title_highlight')}</span>
                            </h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="group cursor-pointer">
                                ...
                                <h3 className="text-xl font-bold whitespace-pre-line">{t('film_1_title')}</h3>
                            </div>
                            <div className="group cursor-pointer">
                                ...
                                <h3 className="text-xl font-bold whitespace-pre-line">{t('film_2_title')}</h3>
                            </div>
                            <div className="group cursor-pointer">
                                ...
                                <h3 className="text-xl font-bold whitespace-pre-line">{t('film_3_title')}</h3>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="relative z-10 py-16 md:py-24 bg-black">
                    <div className="max-w-7xl mx-auto px-4 md:px-8">
                        <h2 className="text-4xl md:text-5xl font-black mb-12 text-center">
                            {t('objectives_title')} <span className="text-pink-500">{t('objectives_title_highlight')}</span>
                        </h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="text-center p-8 bg-zinc-900/30 rounded-2xl border border-zinc-800">
                                ...
                                <h3 className="text-xl font-black mb-4 whitespace-pre-line">{t('objective_1_title')}</h3>
                                <p className="text-gray-400 text-sm">
                                    {t('objective_1_desc')}
                                </p>
                            </div>
                            ...
                            <div className="text-center p-8 bg-zinc-900/30 rounded-2xl border border-zinc-800">
                                ...
                                <h3 className="text-xl font-black mb-4 whitespace-pre-line">{t('objective_2_title')}</h3>
                                <p className="text-gray-400 text-sm">
                                    {t('objective_2_desc')}
                                </p>
                            </div>
                            ...
                            <div className="text-center p-8 bg-zinc-900/30 rounded-2xl border border-zinc-800">
                                ...
                                <h3 className="text-xl font-black mb-4 whitespace-pre-line">{t('objective_3_title')}</h3>
                                <p className="text-gray-400 text-sm">
                                    {t('objective_3_desc')}
                                </p>
                            </div>
                    ...
                    <div className="max-w-7xl mx-auto px-4 md:px-8 text-center">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
                            <div className="p-6 bg-zinc-900/50 rounded-2xl border border-zinc-800">
                                <div className="text-3xl md:text-4xl font-black text-pink-500 mb-2">{t('protocol_stat_1')}</div>
                                <div className="text-gray-500 text-sm">{t('protocol_stat_1_label')}</div>
                            </div>
                            <div className="p-6 bg-zinc-900/50 rounded-2xl border border-zinc-800">
                                <div className="text-3xl md:text-4xl font-black text-green-400 mb-2">{t('protocol_stat_2')}</div>
                                <div className="text-gray-500 text-sm">{t('protocol_stat_2_label')}</div>
                            </div>
                            <div className="p-6 bg-zinc-900/50 rounded-2xl border border-zinc-800">
                                <div className="text-3xl md:text-4xl font-black text-pink-500 mb-2">{t('protocol_stat_3')}</div>
                                <div className="text-gray-500 text-sm">{t('protocol_stat_3_label')}</div>
                            </div>
                            <div className="p-6 bg-zinc-900/50 rounded-2xl border border-zinc-800">
                                <div className="text-3xl md:text-4xl font-black text-blue-400 mb-2">{t('protocol_stat_4')}</div>
                                <div className="text-gray-500 text-sm">{t('protocol_stat_4_label')}</div>
                            </div>
                        </div>
                ...
                <section className="relative z-10 py-16 md:py-24 bg-black">
                    <div className="max-w-7xl mx-auto px-4 md:px-8">
                        <h2 className="text-4xl md:text-5xl font-black mb-12 text-center">
                            {t('conferences_title')}<br />
                            <span className="text-pink-500">{t('conferences_title_highlight')}</span>
                        </h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="p-8 bg-white text-black rounded-2xl">
                                ...
                                <h3 className="text-xl font-black mb-2">{t('event_1_title')}</h3>
                            ...
                            <div className="p-8 bg-zinc-900 rounded-2xl border border-zinc-800">
                                ...
                                <h3 className="text-xl font-black mb-2">{t('event_2_title')}</h3>
                            ...
                            <div className="p-8 bg-zinc-900 rounded-2xl border border-zinc-800">
                                ...
                                <h3 className="text-xl font-black mb-2">{t('event_3_title')}</h3>
                                <p className="text-gray-400">
                                    {t('event_3_desc')}
                                </p>
                            </div>
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                            <div className="flex-1">
                                ...
                                <h2 className="text-5xl md:text-6xl font-black mb-4">
                                    {t('night_title')}<br />
                                    <span className="text-pink-500">{t('night_title_highlight')}</span>
                                </h2>
                            ...
                            <div className="flex flex-col items-center gap-6 p-8 bg-zinc-900/50 rounded-2xl border border-zinc-800">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <div className="text-2xl font-black">{t('night_date')}</div>
                                        <div className="text-gray-400">{t('night_time')}</div>
                                    </div>
                                </div>
                    ...
                    <div className="max-w-7xl mx-auto px-4 md:px-8">
                        <div className="mb-12">
                            ...
                            <h2 className="text-4xl md:text-5xl font-black mb-6">
                                {t('venue_title')}<span className="text-blue-400">{t('venue_title_highlight')}</span>
                            </h2>
                            <div className="flex flex-col md:flex-row gap-8 text-gray-400">
                                <div className="whitespace-pre-line">{t('venue_location_1')}</div>
                                <div className="whitespace-pre-line">{t('venue_location_2')}</div>
                                <div>{t('venue_location_3')}</div>
                            </div>
                        </div>
                        
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="p-8 bg-zinc-900/50 rounded-2xl border border-zinc-800">
                                <h3 className="text-2xl font-black mb-4">{t('venue_room_1_title')}</h3>
                                <p className="text-gray-400">
                                    {t('venue_room_1_desc')}
                                </p>
                            </div>
                            ...
                            <div className="p-8 bg-zinc-900/50 rounded-2xl border border-zinc-800">
                                <h3 className="text-2xl font-black mb-4">{t('venue_room_2_title')}</h3>
                                <p className="text-gray-400">
                                    {t('venue_room_2_desc')}
                                </p>
                            </div>
                    ...
                    <div className="max-w-7xl mx-auto px-10 relative z-10">
                        <div className="mb-20">
                            <h2 className="font-orbitron font-black text-[clamp(36px,6vw,64px)] leading-tight mb-3">
                                {t('stats_title')}<br />
                                <span className="text-[#ec4899] drop-shadow-[0_0_20px_rgba(236,72,153,0.5)]">{t('stats_title_highlight')}</span>
                            </h2>
                    ...
                    <div className="max-w-7xl mx-auto px-10">
                        <div className="text-center mb-20">
                            ...
                            <h2 className="font-orbitron font-black text-[clamp(36px,6vw,64px)] leading-tight">
                                {t('partners_title')} <span className="text-[#06b6d4] drop-shadow-[0_0_20px_rgba(6,182,212,0.5)]">{t('partners_title_highlight')}</span>
                            </h2>
                        </div>
                        ...
                        <div className="text-center mt-16">
                            <button className="px-10 py-4 bg-gradient-to-r from-[#06b6d4] to-[#3b82f6] text-white font-inter font-semibold text-sm tracking-wider uppercase rounded-full hover:translate-y-[-3px] hover:shadow-[0_15px_40px_rgba(6,182,212,0.4)] transition-all duration-300 group relative overflow-hidden">
                                <span className="relative z-10">{t('partners_cta')}</span>
