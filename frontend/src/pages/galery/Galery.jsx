    ...
    const films = [
        {
            ...
            year: 2026,
            country: 'France',
            description: 'Une exploration visuelle des protocoles d\'intelligence artificielle dans un futur dystopique.'
        },
        {
            id: 2,
            title: 'NEURAL DREAM',
            ...
            year: 2026,
            country: 'Belgique',
            description: 'Un voyage onirique à travers les réseaux neuronaux d\'une IA consciente.'
        },
        {
            id: 3,
            ...
            year: 2026,
            country: 'France',
            description: 'Marseille reimaginée dans un futur où l\'IA transforme la ville portuaire.'
        },
        {
            id: 4,
            ...
            year: 2026,
            country: 'Chine',
            description: 'Les frontières entre réalité et simulation s\'estompent dans cette œuvre contemplative.'
        },
        {
            id: 5,
            title: 'QUANTUM SOULS',
            ...
            year: 2026,
            country: 'USA',
            description: 'Une méditation sur la conscience artificielle et l\'âme humaine.'
        },
        {
            id: 6,
            title: 'NEON GENESIS',
            ...
            year: 2026,
            country: 'Japon',
            description: 'La naissance d\'une nouvelle ère à travers les yeux d\'une IA créative.'
        },
        {
            id: 7,
            ...
            year: 2026,
            country: 'UK',
            description: 'Une histoire d\'amour impossible entre humain et intelligence artificielle.'
        },
        {
            id: 8,
            title: 'CODE POETRY',
            ...
            year: 2026,
            country: 'Allemagne',
            description: 'Le code informatique devient poésie visuelle dans cette expérience unique.'
        },
        {
            id: 9,
                ...
                <section className="relative py-32 px-10 bg-gradient-to-br from-[#0a0a0f] via-[#1a0a2e] to-[#050508] overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto relative z-10">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16 max-w-4xl mx-auto">
                            {[
                                { number: t('gallery.gallery_stat_1'), label: t('gallery.gallery_stat_1_label') },
                                { number: t('gallery.gallery_stat_2'), label: t('gallery.gallery_stat_2_label') },
                                { number: t('gallery.gallery_stat_3'), label: t('gallery.gallery_stat_3_label') },
                                { number: t('gallery.gallery_stat_4'), label: t('gallery.gallery_stat_4_label') }
                            ].map((stat, index) => (
                    ...
                    <div className="max-w-7xl mx-auto px-10">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {filteredFilms.map((film, index) => (
                                ...
                                >
                                    {/* Thumbnail */}
                                    <div className={`relative w-full aspect-video rounded-3xl mb-6 ${film.thumbnail} overflow-hidden group-hover:shadow-[0_20px_60px_rgba(168,85,247,0.4)] transition-all duration-500 group-hover:scale-[1.02]`}>
                                        {/* Play button overlay */}
                                        ...
                                        <div className="absolute top-4 left-4 px-3 py-1 bg-[#a855f7]/80 backdrop-blur-sm rounded-full text-white text-xs font-inter font-semibold uppercase">
                                            {categories.find(c => c.id === film.category)?.name.split(' ')[0]}
                                        </div>
                                    </div>
            ...
            {selectedFilm && (
                ...
                >
                    ...
                    >
                        {/* Modal Header */}
                        <div className="relative">
                            <div className={`w-full aspect-video ${selectedFilm.thumbnail} rounded-t-3xl`}></div>
                            <button
                                onClick={() => setSelectedFilm(null)}
