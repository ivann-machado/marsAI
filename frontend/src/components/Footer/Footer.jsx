...
function Footer()
{
    ...
    return (<footer className="bg-gray-900 w-screen px-10 py-20">
            <div className="flex col-4 text-gray-600 mb-20">
                <div className="w-2/6"><p className="text-4xl font-bold text-white mb-7">MARS <span className="text-4xl text-indigo-500 font-bold">AI</span></p><p className="text-gray-600 mb-7">{t('footer_message')}</p>
                    <div className="flex">
                ...
                <div className="w-1/6"><h4 className="text-purple-600 mb-7">{t('navigation')}</h4><ul><li className="mb-7 hover:underline">{t('gallery')}</li><li className="mb-7 hover:underline">{t('schedule')}</li><li className="mb-7 hover:underline">{t('top50')}</li><li className="mb-7 hover:underline">{t('tickets')}</li></ul></div>
                <div className="w-1/6"><h4 className="text-pink-600 mb-7">{t('legal')}</h4><ul><li className="mb-7 hover:underline">{t('partners')}</li><li className="mb-7 hover:underline">{t('faq')}</li><li className="mb-7 hover:underline">{t('contact')}</li><li className="mb-7 hover:underline">{t('legal_notices')}</li></ul></div>
