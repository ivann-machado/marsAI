...
function Footer()
{
    ...
    return (<footer className="bg-gray-900 w-screen px-10 py-20">
            <div className="flex flex-col md:col-4 md:flex-row text-gray-600 mb-20">
                <div className="md:w-2/6 mb-7"><p className="text-4xl font-bold text-white mb-7">MARS <span className="text-4xl text-indigo-500 font-bold">AI</span></p><p className="text-gray-600 mb-7">{t('footer_message')}</p>
                    <div className="flex">
